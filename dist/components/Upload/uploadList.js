...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "lim-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "lim-upload-list-item", key: item.uid },
