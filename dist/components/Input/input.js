 ...
 * ~~~js
 * // 这样引用
 * import { Input } from 'limon-design'
 * ~~~
...
var Input = function (props) {
    ...
    var cnames = classNames('lim-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "lim-input-group-prepend" }, prepend),
        icon && React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon })),
        React.createElement("input", __assign({ className: "lim-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "lim-input-group-append" }, append)));
};
